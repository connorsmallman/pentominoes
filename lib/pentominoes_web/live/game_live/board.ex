defmodule PentominoesWeb.GameLive.Board do
  use PentominoesWeb, :live_component

  alias Pentominoes.Game
  alias Pentominoes.Game.Board
  import PentominoesWeb.GameLive.{Colors, Component}
  ...
  def render(assigns) do
    ...
    <div id={ @id } phx-window-keydown="key" phx-target={ @myself }>
      ...
      <.palette
        ...
        completed_shape_names={Enum.map(@board.completed_pentominoes, & &1.name)}
      />
    </div>
    """
  end
